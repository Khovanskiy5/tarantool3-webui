...
build = {
    ...
    modules = {
        ...
        ['webui.lifecycle.state']        = 'backend/webui/lifecycle/state.lua',
        ['webui.lifecycle.validate']     = 'backend/webui/lifecycle/validate.lua',
        ['webui.lifecycle.apply']        = 'backend/webui/lifecycle/apply.lua',
        ['webui.lifecycle.start']        = 'backend/webui/lifecycle/start.lua',
        ['webui.lifecycle.stop']         = 'backend/webui/lifecycle/stop.lua',
        ['webui.lifecycle.remote_shims'] = 'backend/webui/lifecycle/remote_shims.lua',
        ...
        ['webui.graphql.resolvers.bootstrap']  = 'backend/webui/graphql/resolvers/bootstrap.lua',
        ['webui.graphql.resolvers.cluster_ops'] = 'backend/webui/graphql/resolvers/cluster_ops.lua',
        ['webui.cluster_ops.topology_edit']     = 'backend/webui/cluster_ops/topology_edit.lua',
        ['webui.cluster_ops.promote']           = 'backend/webui/cluster_ops/promote.lua',
        ['webui.failover.disabled']             = 'backend/webui/failover/disabled.lua',
        ['webui.failover.pause']                = 'backend/webui/failover/pause.lua',
        ['webui.failover.commands']             = 'backend/webui/failover/commands.lua',
        ['webui.config_store.bootstrap']       = 'backend/webui/config_store/bootstrap.lua',
        ['webui.notifications']                = 'backend/webui/notifications/init.lua',
        ['webui.notifications.dispatcher']     = 'backend/webui/notifications/dispatcher.lua',
        ['webui.notifications.templates']      = 'backend/webui/notifications/templates.lua',
        ['webui.notifications.signature']      = 'backend/webui/notifications/signature.lua',
        ['webui.notifications.smtp']           = 'backend/webui/notifications/smtp.lua',
        ['webui.graphql.resolvers.webhooks']   = 'backend/webui/graphql/resolvers/webhooks.lua',
