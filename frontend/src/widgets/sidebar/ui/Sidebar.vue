...
const items: SidebarItem[] = [
  {
    ...
    labelKey: 'widgets.sidebar.cluster',
  },
  {
    key: 'issues',
    to: '/issues',
    iconClass: 'pi pi-exclamation-triangle',
    labelKey: 'widgets.sidebar.issues',
  },
  {
    key: 'config-editor',
    to: '/config-editor',
    iconClass: 'pi pi-code',
    labelKey: 'widgets.sidebar.config_editor',
  },
  {
    key: 'data-explorer',
    to: '/data-explorer',
    iconClass: 'pi pi-table',
    labelKey: 'widgets.sidebar.data_explorer',
  },
  ...
  { key: 'users', to: '/users', iconClass: 'pi pi-users', labelKey: 'widgets.sidebar.users' },
  {
    ...
    labelKey: 'widgets.sidebar.failover',
  },
  {
    key: 'cluster-recovery',
    to: '/cluster-recovery',
    iconClass: 'pi pi-shield',
    labelKey: 'widgets.sidebar.cluster_recovery',
  },
  { key: 'vshard', to: '/vshard', iconClass: 'pi pi-th-large', labelKey: 'widgets.sidebar.vshard' },
  {
    ...
    labelKey: 'widgets.sidebar.metrics',
  },
  {
    key: 'snapshots',
    to: '/snapshots',
    iconClass: 'pi pi-database',
    labelKey: 'widgets.sidebar.snapshots',
  },
  { key: 'logs', to: '/logs', iconClass: 'pi pi-file', labelKey: 'widgets.sidebar.logs' },
  {
    ...
    labelKey: 'widgets.sidebar.console',
  },
...
<template>
  <nav class="webui-sidebar" aria-label="primary">
    <ul class="webui-sidebar__list">
      <li v-for="item in items" :key="item.key" class="webui-sidebar__item">
        <router-link
          :to="item.to"
